-- Enhanced SQL DDL from XSD Schema
-- Generated with improved type mapping and choice detection
...
ALTER TABLE refNF ADD CONSTRAINT fk_refNF_nfref_id FOREIGN KEY (nfref_id) REFERENCES NFref(id);
